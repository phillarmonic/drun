...
Teaching your AI agents how to use drun is pretty straightforward.
Using the [Repertoire Skill Manager](https://github.com/phillarmonic/repertoire-ai) you can install the drun skill with:

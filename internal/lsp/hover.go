...
var hoverEntries = []hoverEntry{
	...
	{"create dir", `create dir "path"`, "Create a directory", "Creates a directory at the requested path."},
	...
	{"delete dir", `delete dir "path"`, "Delete a directory", "Removes the selected directory."},

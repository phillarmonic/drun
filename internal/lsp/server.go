...
var keywordCompletions = []completionItem{
	...
	{Label: "requires tools", Kind: completionItemKindKeyword, Detail: "Tool requirements block"},
	{Label: "from tasks", Kind: completionItemKindKeyword, Detail: "Inherit tool requirements from tasks"},
